...
<head>
  ...
  <title>CU_Student portal</title>

  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{asset("finexo-html\css\bootstrap.css")}}" />

  <!-- fonts style -->
  <link href="{{asset("https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700;900&display=swap")}}" rel="stylesheet">
  ...
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="bg_img_box">
        <img src="{{asset("finexo-html\images\images.jpeg")}}" alt="">
      </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ url('/#') }}">Why Us</a>
              </li>
              <li class="nav-item">
          ...
          <div class="carousel-item active">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{asset("finexo-html\images\download.jpeg")}}" alt="">
                  </div>
                </div>
              </div>
            </div>
